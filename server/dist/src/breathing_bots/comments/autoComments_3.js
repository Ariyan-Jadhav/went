...
const GROQ_COMMENT_3 = process.env.GROQ_COMMENT_3;
async function generateComment(data, postContent) {
    const groq = new Groq({ apiKey: GROQ_COMMENT_3 });
...
export async function engagePost3(postId, postContent, excludeUserId) {
...
//# sourceMappingURL=autoComments_3.js.map